...
def setup_cli():
    ...
    key_parser = subparsers.add_parser('password', help='Generate a secure password')
    key_parser.add_argument('-l', '--length', type=parse_length, default=None, help='The length of the new password')
    key_parser.add_argument('-a', '--alpha', action='store_true', help='Use alpha (letters) only')
